            ...
            {allBatch.map(function (ele) {
              return (
                ...
                >
                  ...
                  <Link
                    to={`/teachersession/${ele._id}`}
                    className="absolute bottom-0 right-0 flex h-12 w-12 items-center justify-center bg-violet-500 text-white transition-all hover:w-16"
                  >
                    <svg
